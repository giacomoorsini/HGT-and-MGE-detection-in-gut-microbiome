...
#PBS -q CIBIO_cpuQ
#PBS -o "/shares/CIBIO-Storage/CM/scratch/users/giacomo.orsini/waafle/CM_ghanatanzania_animals/stdir/recover.out"
#PBS -e "/shares/CIBIO-Storage/CM/scratch/users/giacomo.orsini/waafle/CM_ghanatanzania_animals/stdir/recover.err"
...
for file in $TMP/*; do
        ...
        JOBID=$(echo "$filename" | awk -F "_" '{print $1}' | awk -F "-" '{print $2"-"$3}' )
